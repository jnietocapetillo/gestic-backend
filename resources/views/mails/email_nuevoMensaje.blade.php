...
<body>
    <div class="container w-50">
        ...
        <div class="d-flex flex-row pt-5 pb-5 justify-content-center border border-dark">
            <div class="p-2">
                <h4>SE HA ENVIADO NUEVO MENSAJE A INCIDENCIA</h4>
                <h5 class="pt-3">DATOS:</h5>
                <h6 class="text-primary pt-3">Número incidencia: {{$datos -> incidencia}}</h6>
                <h6 class="text-primary pt-3 pb-5">Usuario: {{$datos -> usuario}}</h6>
                
                <span>Acceda a la plataforma, incidencias y mensajes asociados.</span>
            </div>
        </div>
